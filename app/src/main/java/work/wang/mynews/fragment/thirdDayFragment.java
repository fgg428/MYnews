...
public class thirdDayFragment extends Fragment {
    ...
    public void init(View v ){
        city=(TextView)v.findViewById(R.id.third_tv);
        date=(TextView)v.findViewById(R.id.third_date);
        high=(TextView)v.findViewById(R.id.third_high);
        low=(TextView)v.findViewById(R.id.third_low);
        white_type=(TextView)v.findViewById(R.id.third_white_type);
        white_fengxiang=(TextView)v.findViewById(R.id.third_white_fengxiang);
        white_fengli=(TextView)v.findViewById(R.id.third_white_fengli);
        black_type=(TextView)v.findViewById(R.id.third_black_type);
        black_fengxiang=(TextView)v.findViewById(R.id.third_black_fengxiang);
        black_fengli=(TextView)v.findViewById(R.id.third_black_fengli);
    }
    public void onAttach(Activity activity) {
        super.onAttach(activity);
        s_city=((weather)activity).city();
        infoList = ((weather) activity).info();
        s_date=infoList.get(2).getDate().toString();
        s_high=infoList.get(2).getHigh().toString();
        s_low=infoList.get(2).getLow().toString();
        s_w_type=infoList.get(2).getWhite_type().toString();
        s_w_fengxiang=infoList.get(2).getWhite_fengxiang().toString();
        s_w_fengli=infoList.get(2).getWhite_fengli().toString();
        s_b_type=infoList.get(2).getBlack_type().toString();
        s_b_fengxiang=infoList.get(2).getBlack_fengxiang();
        s_b_fengli=infoList.get(2).getBlack_fengli();
    }
